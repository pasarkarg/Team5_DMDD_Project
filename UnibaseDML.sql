...
procedure insert_mutual_fund_details(schemeid in varchar2, mname in varchar2, risk in varchar2, netav in float );
...
procedure insert_foreign_exchange_details(currencyid in varchar2,curname in varchar2, country in varchar2, iso in varchar2, cur_price in float);
procedure insert_foreign_exchange_transactions(transactid in number, currencyid in varchar2,customerid in number,transacdate in date, pcurid in varchar2, investvalue in float, pcurvalue in float, curtransacttp in varchar2);
...
procedure insert_crypto_transaction(transactid in number, cryptoid in varchar2, customerid in number,transacdate in date, transacttype in char, crypunit in number, crypprice in number, crypexchange in varchar2  );
...
procedure insert_stock_transactions(transactid in number,stockid in varchar2,customerid in number, transacdate in date, sunit in number,sprice in number,transacttype in char,stkexchange in VARCHAR2 );
...
procedure insert_mutual_fund_details(schemeid in varchar2, mname in varchar2, risk in varchar2, netav in float )as
begin
...
procedure insert_foreign_exchange_details(currencyid in varchar2,curname in varchar2, country in varchar2, iso in varchar2, cur_price in float) as
begin
...
procedure insert_foreign_exchange_transactions(transactid in number, currencyid in varchar2,customerid in number,transacdate in date, pcurid in varchar2, investvalue in float, pcurvalue in float, curtransacttp in varchar2) as
begin
...
procedure insert_crypto_transaction(transactid in number, cryptoid in varchar2,customerid in number,transacdate in date, transacttype in char, crypunit in number, crypprice in number, crypexchange in varchar2  ) as
begin
...
procedure insert_stock_transactions(transactid in number,stockid in varchar2,customerid in number, transacdate in date, sunit in number,sprice in number,transacttype in char,stkexchange in VARCHAR2 )as
begin
