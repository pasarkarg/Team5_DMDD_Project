...
SELECT CUSTOMER_ID, VW_STOCK_STATISTICS.STOCK_INVESTMENT_RESULT, VW_MUTUAL_STATISTICS.MUTUAL_FUND_INVESTMENT_RESULT,
VW_CRYPTO_STATISTICS.CRYPTO_INVESTMENT_RESULT, VW_CURRENCY_STATISTICS.CURRENCY_INVESTMENT_RESULT
FROM
VW_STOCK_STATISTICS
INNER JOIN  VW_MUTUAL_STATISTICS
ON VW_STOCK_STATISTICS.CUSTOMER_ID = VW_MUTUAL_STATISTICS.CUSTOMER_ID
INNER JOIN VW_CRYPTO_STATISTICS
ON VW_STOCK_STATISTICS.CUSTOMER_ID = VW_CRYPTO_STATISTICS.CUSTOMER_ID
INNER JOIN VW_CURRENCY_STATISTICS
ON VW_STOCK_STATISTICS.CUSTOMER_ID = VW_CURRENCY_STATISTICS.CUSTOMER_ID;
----------------------------------------------------------------------------------------------------------------------

--CREATING SEQUENCE FOR ALL THE TRANSACTION TABLES, FEEDBACK TABLE--
