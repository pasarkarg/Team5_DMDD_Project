...
IF(numCount > 0)
THEN
    DBMS_OUTPUT.PUT_LINE('CUSTOMER_DETAILS TABLE ALREADY EXISTS');
ELSE
...
IF(numCount > 0)
THEN
    DBMS_OUTPUT.PUT_LINE('MUTUAL_FUND_DETAILS TABLE ALREADY EXISTS');
ELSE
...
IF(numCount > 0)
THEN
    DBMS_OUTPUT.PUT_LINE('MUTUAL_FUND_TRANSACTION TABLE ALREADY EXISTS');
ELSE
...
IF(numCount > 0)
THEN
    DBMS_OUTPUT.PUT_LINE('FOREIGN_EXCHANGE_DETAILS TABLE ALREADY EXISTS');
ELSE
...
IF(numCount > 0)
THEN
    DBMS_OUTPUT.PUT_LINE('FOREIGN_EXCHANGE_TRANSACTIONS TABLE ALREADY EXISTS');
ELSE
...
IF(numCount > 0)
THEN
    DBMS_OUTPUT.PUT_LINE('CRYPTO_DETAILS TABLE ALREADY EXISTS');
ELSE
...
IF(numCount > 0)
THEN
    DBMS_OUTPUT.PUT_LINE('CRYTPO_TRANSACTIONS TABLE ALREADY EXISTS');
ELSE
...
IF(numCount > 0)
THEN
    DBMS_OUTPUT.PUT_LINE('CUSTOMER_FINANCIAL_DETAILS TABLE ALREADY EXISTS');
ELSE
