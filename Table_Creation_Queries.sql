...
CREATE TABLE FOREIGN_EXCHANGE_DETAILS(
    ...
    CURRENCY_CURRENT_PRICE NUMBER(10, 2) NOT NULL,
...
CREATE TABLE FOREIGN_EXCHANGE_TRANSACTIONS(
    ...
    PURCHASED_CURRENCY_VALUE NUMBER(10, 2) NOT NULL,
    CURRENCY_TRANSACTION_TYPE VARCHAR(20) NOT NULL,
    FEX_LATEST_PRICE NUMBER(10, 2) NOT NULL,
...
CRYPTO_NAME VARCHAR2(20 BYTE) NOT NULL,
...
NUMBER_OF_UNITS NUMBER(10,0) NOT NULL, 
UNIT_STOCK_PRICE NUMBER(10,2) NOT NULL, 
STOCK_TRANSACTION_TYPE CHAR(1 BYTE) NOT NULL,
STOCK_EXCHANGE VARCHAR2 (10 BYTE) NOT NULL,
